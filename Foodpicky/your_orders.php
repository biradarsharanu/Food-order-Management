            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/foodpicky3.png" alt="Footer logo"> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
                    <div class="col-xs-12 col-sm-2 about color-gray">
                        <h5>About Us</h5>
                        <ul>
                        <li><a href="#">"Serving delectable</a></li>
                            <li><a href="#">moments to your doorstep</a></li>
                            <li><a href="#">with a symphony of flavors</a></li>
                            <li><a href="#">– we deliver joy</a></li>
							<li><a href="#">in every bite."</a></li>
                        </ul>
                    </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Bhoomika Layout, RR Nagar Benagaluru</p>
                            <h5>Call us at: <a>+91 8217074706</a></h5></div>
